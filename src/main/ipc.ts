...
import type { AccountTransferInput, AppSettings, ClientSettingsUpdateInput, ControlCommandInput, ControlSettings, JoinServerInput, ServerQuery, UpdateAccountInput, UpdateGameInput, WebApiUpdateInput, WatcherUpdateInput } from '../shared/types'
...
export function registerIpcHandlers(services: IpcServices): void {
  const { store, roblox, webApi, watcher, sessions, control, secrets, getWindow } = services
