...
const api: VirgueApi = {
  ...
  backgroundInput: {
    ...
    startSchedule: (input: BackgroundInputScheduleInput) => ipcRenderer.invoke(IPC_CHANNELS.backgroundInputStartSchedule, input),
    pauseSchedule: (id: string) => ipcRenderer.invoke(IPC_CHANNELS.backgroundInputPauseSchedule, id),
    resumeSchedule: (id: string) => ipcRenderer.invoke(IPC_CHANNELS.backgroundInputResumeSchedule, id),
    stopSchedule: (id: string) => ipcRenderer.invoke(IPC_CHANNELS.backgroundInputStopSchedule, id),
  },
  protectedSession: {
    ...
    showViewer: () => ipcRenderer.invoke(IPC_CHANNELS.protectedSessionShowViewer),
  },
  autoHotkey: {
    getSnapshot: () => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyGetSnapshot),
    save: (input: AutoHotkeyScriptInput) => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeySave, input),
    remove: (id: string) => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyRemove, id),
    run: (id: string) => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyRun, id),
    stop: (id: string) => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyStop, id),
    openDownload: () => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyOpenDownload),
    getAiStatus: () => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyAiStatus),
    downloadAiModel: () => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyAiDownload),
    generateAiScript: (request: string) => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyAiGenerate, request),
    cancelAi: () => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyAiCancel),
    removeAiModel: () => ipcRenderer.invoke(IPC_CHANNELS.autoHotkeyAiRemoveModel),
  },
  watcher: {
